...
TELEGRAM_BOT_TOKEN = '7930013954:AAEHOctnkHSotMdMqaz4bODI2sWMoz28s38'
ADMIN_USER_ID = 6373931635
...
async def attack(update: Update, context: CallbackContext):
    ...
    text=(
        ...
        f"*🔥chudai chalu h feedback bhej dena @PRINCE_OP5💥*"
    ),
    parse_mode='Markdown'
)
